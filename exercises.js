...
console.log(login('test1234')); //"Login Success!"
console.log(login('letmein777')); // "error: password incorrect"
...
console.log(mustBeTrue(true)); //true
...
console.log(bigBird('two')); // "Word to Big Bird!"
console.log(bigBird('snuffelufugus')); //"No"
...
console.log(isEqual('griffey', 'griffey')); // "You look mahvelous"
console.log(isEqual('griffey', 'thomas')); // "I don't know who you are anymore."
/*
 * #7
 * Function - notEqual
...
console.log(dirty30(10,11,12)); //true
console.log(dirty30(7,8,9)); //false
...
console.log(evenStevens(80)); // Q10 true
console.log(evenStevens(79)); // Q10 false
...
console.log(daClub(22,22)); // Welcome to the Legends Lounge
console.log(daClub(22,20)); // Chuck E Cheese is across the street
...
console.log(moneyTrain(40)); // You are riding Honolulu's Rail."
console.log(moneyTrain(90)); // You are riding an Amtrak."
console.log(moneyTrain(150)); // Now you ballin' in the Shinkansen!"
...
function buyDoughnut(){
 if (budget >= doughnutPrice){
  ...
  doughnutBought++;
  return 'Budget: ' + budget + ' Doughunut Bought: ' + doughnutBought;
 }
}
console.log(buyDoughnut()); // Budget: 21 Doughnut Bought: 1
console.log(budget); //21
console.log(doughnutBought); //1
console.log(buyDoughnut()); // Budget: 17 Doughnut Bought: 2
console.log(budget); //17
console.log(doughnutBought); //2
